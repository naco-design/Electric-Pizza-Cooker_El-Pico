...
// 調整パラメーター
int targetTEMP_Up = 500;         // 上プレート設定温度 窯の天井の温度 ：約485度
int targetTEMP_Lw = 420;         // 下プレート設定温度 炉床の温度 ：約380～430度
const int LimitHeaterTEMP = 800; // ヒーターリミット
unsigned long TCinterval = 1000; // TC計測間隔(ms)
...
// プリセットの定義
int presetsUp[4] = {500, 330, 300, 220};                                   // 上プレートのプリセット値
int presetsLw[4] = {430, 310, 300, 200};                                   // 下プレートのプリセット値
